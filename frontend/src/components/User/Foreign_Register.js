        ...
        <div className="body1">
            ...
            {/* {error && <ErrorNotice message={error} clearError={() => setError(undefined)} />} */}
                <form className='was-validated'onSubmit={sendData}>
                    <h3 className="text-center">Foreign Register</h3>
                    ...
                    <br></br>
                        <br></br>
                        <p>Have a account already ?<Link to ='/Foreign_Login'><button1>Sign In Now</button1></Link></p>
                </form>
            </div>
        </div>
        <Footer/>
