            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div className="navbar-nav Navbtn">
                        ...
                        <Link to="/add" type="radio" className="btn nav-link anime color" style={{color:"white"}} aria-current="page">Add Schedule</Link>
                        <Link to="/view" type="radio" className="btn nav-link anime color active" style={{color:"white"}}>Schedule Tabel</Link>
